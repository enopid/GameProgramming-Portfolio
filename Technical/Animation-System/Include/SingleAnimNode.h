...
class ENGINE_DLL CSingleAnimNode final : public CAnimNode
{
public:
	virtual ~CSingleAnimNode() = default;
protected:
	CSingleAnimNode(shared_ptr<CModel>	spModel);
	CSingleAnimNode(const CSingleAnimNode& prototype, shared_ptr<CModel>	spModel);
...
public:
	...
	static  unique_ptr<CSingleAnimNode>	Create(Json::Value jsonValue, shared_ptr<CModel>	spModel);
private:
